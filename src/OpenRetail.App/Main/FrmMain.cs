/**
 * Copyright (C) 2018 Tech Source Code Store (https://goo.gl/maps/s4z7ujEHGfYJfsbu7)
 *
...
namespace OpenRetail.App.Main
{
    public partial class FrmMain : Form, IListener
    {
        ...
        private void mnuGoogleMapsTechSourceCodeStore_Click(object sender, EventArgs e)
        {
            var url = "https://goo.gl/maps/s4z7ujEHGfYJfsbu7";
            OpenUrl(url);
        }

        private void mnuGroupWhatsapp_Click(object sender, EventArgs e)
        {
            var url = "https://chat.whatsapp.com/KWQvoIorVbGKQrgInyybqQ";
            OpenUrl(url);
        }

        private void mnuFacebookPage_Click(object sender, EventArgs e)
        {
            var url = "https://www.facebook.com/tmd.indo";
            OpenUrl(url);
        }



        private void mnuSupportTST_Click(object sender, EventArgs e)
        {
            var url = "https://goo.gl/maps/s4z7ujEHGfYJfsbu7";
            OpenUrl(url);
        }
        ...
        private void mnuAkunOwner_Click(object sender, EventArgs e)
        {
            var url = "https://www.instagram.com/anandarauf08";
            OpenUrl(url);
        }
    }
}
